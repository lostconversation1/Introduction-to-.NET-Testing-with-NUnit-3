...
namespace Loans.Tests
{
    ...
    public class LoanTermShould
    {
        ...
        [Test]
        public void RespectValueEqualityValueType()
        {
            var a = 1;
            var b = 1;
        ...
        [Test]
        public void RespectValueEqualityReferenceType()
        {
        ...
        public void ReferenceEqualityExample()
        {
            ...
            //point to the same point in the memory
        ...
        public void NotAllowZeroYears()
        {
            ...
            //Correct ex and para name bt don't care about message
            Assert.That(() => new LoanTerm(0), Throws.TypeOf<ArgumentOutOfRangeException>()
              .With
              .Property("ParamName")
              .EqualTo("years")
